            ...
            <div class="mx-auto max-w-2xl py-10 sm:py-12 lg:py-14">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        <b>Samuel Chrisdian</b> Fullstack Developer MediaWave Recruitment Test. 
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Indonesia Social Media User Area & Number Dashboard</h1>
